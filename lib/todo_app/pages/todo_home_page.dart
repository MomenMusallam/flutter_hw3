  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
        ...
        child: Scaffold(
          ...
          body: TabBarView(
            children: [
              AllTasksScreen(changeTaskCompleteness,removeTask),
              CompleteTasksScreen(changeTaskCompleteness,removeTask),
              InCompleteTasksScreen(changeTaskCompleteness,removeTask)
            ],
          ),
        ));
  }
